...
AI_HOBBYIST_ROOT = LOCAL_DIR / "ai_hobbyist"
...
AI_HOBBYIST_SPEAKER = _env_str("AI_HOBBYIST_SPEAKER", "")
AI_HOBBYIST_INBOX_DIR = _env_str("AI_HOBBYIST_INBOX_DIR", "")
AI_HOBBYIST_DEFAULT_LANGUAGE = _env_str("AI_HOBBYIST_DEFAULT_LANGUAGE", "ja")
AI_HOBBYIST_DEFAULT_PROBABILITY = _env_float("AI_HOBBYIST_DEFAULT_PROBABILITY", 0.99)
